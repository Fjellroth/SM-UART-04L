    //Christer- This sketch is an edited version of the one downloaded from github, 
    ...
    //The sample rate is as fast as the sketch will run, when adding a 3 second delay for example the serial monitor would display "checksum error" after each data set.
    ...
    void loop() {
      ...
      //  Serial.println();
       ...
       // Serial.println("Concentration Units (standard)");
        ...
        Serial.print("\t\t,PMB 10:, "); Serial.print(data.pm100_standard); Serial.println(",");
        //Serial.println("------------------B---------------------");
        //Serial.println("Concentration Units (environmental)");
        //Serial.print("PM 1.0: "); Serial.print(data.pm10_env);
       // Serial.print("\t\tPM 2.5: "); Serial.print(data.pm25_env);
